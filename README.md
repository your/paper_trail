# PaperTrail [![Build Status](https://secure.travis-ci.org/airblade/paper_trail.png?branch=2.7-stable)](http://travis-ci.org/airblade/paper_trail) [![Dependency Status](https://gemnasium.com/airblade/paper_trail.png)](https://gemnasium.com/airblade/paper_trail)
...
Works on Rails 3 and Rails 2.3.  The Rails 3 code is on the `2.7-stable` branch and tagged `v2.x`.  The Rails 2.3 code is on the `rails2` branch and tagged `v1.x`.  Please note I'm not adding new features to the Rails 2.3 codebase.
